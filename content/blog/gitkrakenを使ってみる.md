...
今回はGitKrakenというツールのご紹介と導入方法、実際にリポジトリ作成からリモートリポジトリへのPushまでを解説しました。\
個人的にはCUIのコマンドでどういったことをしているのか、非常にわかりやすいなと感じたので、これからも活用していきたいと思います。

それでは今回はこの辺りで。\
ここまで読んでいただき、ありがとうございました！\
感想やご意見等ございましたら、[私のTwitter](https://twitter.com/RinGoku98)までお気軽にどうぞ。はじめに
...
それでは今回はこの辺りで。\
ここまで読んでいただき、ありがとうございました！\
感想やご意見等ございましたら、[私のTwitter](https://twitter.com/RinGoku98)までお気軽にどうぞ。