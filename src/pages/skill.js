...
import SlackImg from '../assets/images/skills/slack.png';
...
const backendSkills = [
  ...
  { name: 'PHP', img: phpImg, term: '0.5 year', description: 'Pure JavaScriptよりも先にjQueryに触れたタイプの人間です(後々苦労しました笑)。今は積極的に触っていませんが、必要とあれば使うこともできると思います' },
];

const otherSkill = [
  { name: 'GitHub', img: GithubImg, term: '1 year', description: '初めて触れたプログラミング言語です。Spring FrameworkやMybatis、Jerseyなどのフレームワークを使った開発経験が3年ほどあります。JavaScriptの次に触ってきた言語だと思います' },
  { name: 'Wordpress', img: WordpressImg, term: 'half year', description: '自作テーマの改修案件に携わったことがあり、最低限の知識はあります。' },
  { name: 'Slack', img: SlackImg, term: 'half year', description: '自作テーマの改修案件に携わったことがあり、最低限の知識はあります。' },
];
    ...
    <Layout>
      ...
      <Main>
        <Section>
          ...
          <Subtitle>ツール・その他</Subtitle>
          <SkillStack skills={otherSkill} />
        </Section>
      </Main>
    </Layout>
  );
